...
const assetTypes_1 = require("../utils/assetTypes");
    ...
    */
    ...
    (0, requests_1.searchStocks)(query)
        ...
        const filteredQuotes = quotes.filter((quote) => {
            var _a;
            const quoteType = (_a = quote.quoteType) === null || _a === void 0 ? void 0 : _a.toUpperCase();
            return assetTypes_1.ENABLED_ASSET_TYPES.has(quoteType) &&
                !(0, assetTypes_1.isCryptoSymbol)(quote.symbol);
        });
...
exports.default = { getInfo, buyStock, sellStock, search };
