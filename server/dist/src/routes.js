...
router.post("/api/auth/login", auth_controller_1.default.login, middleware_1.verifySignUp.checkDuplicateEmail, middleware_1.verifySignUp.checkDuplicateUsername);
// Password reset route (forgot-password)
router.post('/api/auth/forgot-password', auth_controller_1.default.forgotPassword, middleware_1.verifySignUp.checkDuplicateEmail, middleware_1.verifySignUp.checkDuplicateUsername);
// User data routes
